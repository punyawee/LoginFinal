...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container" style="margin-top: 80px">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id_choice" DataSourceID="SqlDataSource1" Width="100%" CssClass="table table-bordered table-hover table-responsive" AllowPaging="True" AllowSorting="True" PageSize="15" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
                <Columns>
